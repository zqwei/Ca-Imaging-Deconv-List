...
names = ['dF/F', 'S2C-L', 'S2C-H', 'S2C-S', 'NWF', 'FOOPSI', 'FRI', 'AR1', 'AR2', 'AR3', 'MCMC', 'Peel', 'MLS']
...
for nFolder in glob('MV1*'):
    ...
    for nFile in range(len(spkFiles)):
        ...
        p = figure(plot_width=1050, plot_height=400, x_axis_label="Time(sec)", y_axis_label="dF/F", x_range=(0, 240))
